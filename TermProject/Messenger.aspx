<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Messenger.aspx.cs" Inherits="TermProject.Messenger" %>

<%@ Register Src="MessengerControl.ascx" TagName="MessengerControl" TagPrefix="uc1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <uc1:MessengerControl ID="MessengerControl1" runat="server" />
            </div>
        </div>
    </form>
</body>
